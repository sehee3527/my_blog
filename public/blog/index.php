...
<div class="main-bn visible-md-up">
    ...
    <div class="slider">
        <div class="triangle active"><img src="/resource/img/triangle-2.png" alt=""></div>
        <div class="triangle"><img src="/resource/img/triangle-3.png" alt=""></div>
        <div class="triangle"><img src="/resource/img/triangle-1.png" alt=""></div>
    </div>
    <div class="side-bars flex">
        <div class="bar active flex flex-1-0-0 flex-jc-c flex-ai-c">
            <div></div>
        </div>
        <div class="bar flex flex-1-0-0 flex-jc-c flex-ai-c">
            <div></div>
        </div>
        <div class="bar flex flex-1-0-0 flex-jc-c flex-ai-c">
            <div></div>
...
<div class="fixed-img"><img
        src="https://images.unsplash.com/photo-1591563710505-7ebbc61ed8ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
        alt=""></div>
...
<div class="bn-3">
    <div class="yellow-circle">
        ...
        <div class="slider flex">
            <div class="flex flex-ai-c flex-jc-c"><i class="fas fa-chevron-left"></i></div>
            <div class="flex flex-ai-c flex-jc-c"><i class="fas fa-chevron-right"></i></div>
        </div>
        <div class="portflio-bn-content">
            <img src="/resource/img/triangle-2.png" alt="">
        </div>
        <div class="portflio-view">
            <div></div>
            <a href="#">자세히 보기</a>
        </div>
    </div>
