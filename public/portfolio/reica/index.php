...
<head>
    ...
    <link rel="stylesheet" href="/portfolio/reica/index.css">
    <script src="/portfolio/reica/index.js"></script>
...
<body>
    ...
    <section class="main-middle con-min-width">
        ...
        <!-- 2번째 배너 -->
        <div class="bn-2 con flex">
            <div class="bn-2-img img-box">
                <img src="http://sehee3527.github.io/img1/pf/reica/reica-bn2.png" alt="">
            </div>
            <div class="bn-2-content flex flex-column-nowrap flex-jc-sb">
                <div class="name">REICA</div>
                <div class="content flex-grow-1">라이카 브랜드의 명성은 오랜 세월을 거쳐온 전통과 렌즈, 다양한 광학 기기의 우수함에서 찾아볼 수 있습니다.</div>
                <div class="sub flex flex-js-e flex-column-nowrap">
                    <div>Ergonomics<span>실용적으로 컴팩트하며 <br>인체공학적으로 사용자에게 맞추다.</span></div>
                    <div>Innovative<span>유니크한 경험을 선사하기 위해 <br>혁신적인 도구를 개발하다.</span></div>
                </div>
            </div>
        </div>
        <div class="bn-3">
