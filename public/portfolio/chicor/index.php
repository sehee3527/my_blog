...
<head>
    ...
    <link rel="stylesheet" href="/portfolio/chicor/common.css">
    <link rel="stylesheet" href="/portfolio/chicor/index.css">
    <script src="/portfolio/chicor/index.js"></script>
</head>

<body>
    <div class="top-bar con-min-width">
        <div class="top-bar-box flex flex-jc-sb flex-ai-c">
            <div>
                <a href="">로그인</a><a href="">회원가입</a>
            </div>
            <div class="logo img-box"><img src="https://sehee3527.github.io/img1/pf/chicor/logo.png" alt=""></div>
            <div class="top-bar-right flex flex-ai-c">
                <div>
                    <div
                        style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/common.png);background-position:-110px -176px;">
                    </div>
                </div>
                <div class="img-box"
                    style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/common.png);background-position:-88px -176px;">
                </div>
                <div class="img-box"
                    style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/common.png);background-position:0px -176px;">
                </div>
                <div class="img-box"
                    style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/common.png);background-position:-132px -176px;">
                </div>
            </div>
        </div>
    </div>
    <div class="fly-top-bar con-min-width">
        <div class="fly-top-bar-box flex flex-jc-sb con">
            <ul class="fly-top-bar-left flex">
                <li><a href="">스킨케어</a>
                    <div class="top-bar-item-in-box">
                        <div class="top-bar-item-item flex">
                            <div class="top-bar-item-item-name">
                                <div>스킨케어</div>
                                <a href="">전체보기></a>
                            </div>
                            <div class="top-bar-item-item-content">
                                <ul class="flex flex-row-wrap">
                                    <li>
                                        <div class="name">페이셜케어</div>
                                        <a href="">스킨/토너</a><br>
                                        <a href="">로션</a><br>
                                        <a href="">에센스/세럼</a><br>
                                        <a href="">크림/젤/밤</a><br>
                                    ...
                                    <li>
                                        ...
                                        <div class="name">클렌징</div>
                                        <a href="">클렌징워터/오일</a><br>
                                        <a href="">클렌징젤/폼/솝</a><br>
                                        <a href="">클렌징밀크/크림/밤</a><br>
                                        <a href="">아이/립 리무버</a><br>
                                        <a href="">클렌징티슈/패드</a><br>
                                        <a href="">스크럽/필링</a><br>
                                        <a href="">클렌징/마사지기기</a><br>
                                    </li>
                                    <li>
                                        <div class="name">마스크/팩</div>
                                        <a href="">시트마스크</a><br>
                                        <a href="">워시오프팩</a><br>
                                        <a href="">슬리핑팩</a><br>
                                        <a href="">부분 패치</a><br>
                                    ...
                                    <li>
                                        <div class="name">선케어</div>
                                        <a href="">선크림</a><br>
                                        <a href="">선쿠션</a><br>
                                        <a href="">선스틱/스프레이</a><br>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="top-bar-item-in-box">
                        <div class="top-bar-item-item flex">
                            ...
                            <div class="top-bar-item-item-content">
                                <ul class="flex flex-row-wrap">
                                    <li>
                                        <div class="name">베이스메이크업</div><br>
                                        <a href="">프라이머/베이스</a><br>
                                        <a href="">BB/CC</a><br>
                                        <a href="">파운데이션</a><br>
                                        <a href="">쿠션</a><br>
                                        <a href="">컨실러</a><br>
                                    ...
                                    <li>
                                        ...
                                        <div class="name">립메이크업</div>
                                        <a href="">립스틱</a><br>
                                        <a href="">립틴트/락커</a><br>
                                        <a href="">립글로스</a><br>
                                        <a href="">립펜슬/립라이너</a><br>
                                        <a href="">립에센스/립밤</a><br>
                                    <li>
                                        <div class="name">아이메이크업</div>
                                        <a href="">아이라이너</a><br>
                                        <a href="">아이브로우</a><br>
                                        <a href="">아이새도우/팔레트</a><br>
                                        <a href="">마스카라</a><br>
                                        <a href="">아이크라이머</a><br>
                                        <a href="">아이래쉬/속눈썹영양제</a><br>
                                    </li>
                                    <li>
                                        <div class="name">블러셔/하이라이터/쉐딩</div>
                                        <a href="">블러셔/치크</a><br>
                                        <a href="">하이라이터</a><br>
                                        <a href="">쉐딩/컨투어링</a><br>
                                    </li>
                                    <li>
                                        <div class="name">네일케어</div>
                                        <a href="">네일폴리쉬</a><br>
                                        <a href="">하이라이터</a><br>
                                        <a href="">쉐딩/컨투어링</a><br>
                                    </li>
                        ...
                        <div class="top-bar-item-item flex">
                            ...
                            <div class="top-bar-item-item-content">
                                <ul class="flex flex-row-wrap">
                                    ...
                                    <li>
                                        <div class="name">메이크업</div>
                                        <a href="">베이스/BB/CC</a><br>
                                        <a href="">립밤/립틴트</a><br>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="top-bar-item-in-box">
                        <div class="top-bar-item-item flex">
                            ...
                            <div class="top-bar-item-item-content">
                                <ul class="flex flex-row-wrap">
                                    <li>
                                        <div class="name">바디워시</div>
                                        <a href="">바디클렌저/비누</a><br>
                                        <a href="">바디스크럽</a><br>
                                        <a href="">입욕제</a><br>
                                        <a href="">여성청결제</a><br>
                                    </li>
                                    <li>
                                        ...
                                        <div class="name">바디보습</div>
                                        <a href="">바디로션</a><br>
                                        <a href="">바디크림/젤/밤</a><br>
                                        <a href="">바디오일/에센스</a><br>
                                        <a href="">바디미스트</a><br>
                                    </li>
                                    <li>
                                        <div class="name">핸드/풋</div>
                                        <a href="">해드워시</a><br>
                                        <a href="">핸드크림/밤</a><br>
                                        <a href="">세니타이저</a><br>
                                        <a href="">풋크림</a><br>
                    ...
                    <div class="top-bar-item-in-box">
                        <div class="top-bar-item-item flex">
                            ...
                            <div class="top-bar-item-item-content">
                                <ul class="flex flex-row-wrap">
                                    <li>
                                        <div class="name">향수</div>
                                        <a href="">여성향수</a><br>
                                        <a href="">남성향수</a><br>
                                        <a href="">스틱/롤온</a><br>
                                        <a href="">향초/디퓨저/방향제</a><br>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="top-bar-item-in-box">
                        <div class="top-bar-item-item flex">
                            ...
                            <div class="top-bar-item-item-content">
                                <ul class="flex flex-row-wrap">
                                    <li>
                                        <div class="name">샴푸/린스/트리트먼트</div>
                                        <a href="">샴푸/린스</a><br>
                                        <a href="">트리트먼트/헤어팩</a><br>
                                        <a href="">세트</a><br>
                                    </li>
                                    <li>

                                        <div class="name">염모제</div>
                                        <a href="">염색</a><br>
                                    </li>
                                    <li>
                                        <div class="name">헤어스타일링</div>
                                        <a href="">드라이샴푸</a><br>
                                        <a href="">헤어에센스/오일</a><br>
                                        <a href="">헤어젤/스프레이/무스</a><br>
                                        <a href="">헤어왁스/포마드</a><br>
                                        <a href="">헤어미스트</a><br>
                                    </li>
                                    <li>
                                        <div class="name">헤어기기</div>
                                        <a href="">드라이기</a><br>
                                        <a href="">헤어 아이론</a><br>
                                    </li>
                                </ul>
                    ...
                    <div class="top-bar-item-in-box">
                        <div class="top-bar-item-item flex">
                            ...
                            <div class="top-bar-item-item-content">
                                <ul class="flex flex-row-wrap">
                                    <li>
                                        <div class="name">페이스소품</div>
                                        <a href="">메이크업브러쉬</a><br>
                                        <a href="">스펀지/버프</a><br>
                                        <a href="">브러시/퍼프 클린저</a><br>
                                        <a href="">화장솜</a><br>
                                        <a href="">면봉</a><br>
                                    </li>
                                    <li>
                                        <div class="name">아이소품</div>
                                        <a href="">눈썹손질도구/족집게</a><br>
                                        <a href="">뷰러/고데기</a><br>
                                        <a href="">속눈썹</a><br>
                                        <a href="">쌍꺼풀</a><br>
                                    </li>
                                    <li>
                                        <div class="name">네일소품</div>
                                        <a href="">네일도구</a><br>
                                    </li>
                                    <li>
                                        <div class="name">바디소품</div>
                                        <a href="">샤워용품</a><br>
                                        <a href="">클렌징도구</a><br>
                                    </li>
                                    <li>
                                        <div class="name">헤어소품</div>
                                        <a href="">헤어브러쉬</a><br>
                                        <a href="">헤어액세서리</a><br>
                                        <a href="">헤어롤</a><br>
                                    </li>
                                    <li>
                                        <div class="name">기타화장소품</div>
                                        <a href="">거울</a><br>
                                        <a href="">파우치</a><br>
                                        <a href="">기타</a><br>
                                    </li>
                                    <li>
                                        <div class="name">잡화</div>
                                        <a href="">잡화</a><br>
                                        <a href="">마스크</a><br>
                                    </li>
                                </ul>
            ...
            <ul class="fly-top-bar-right flex">
                <li><a href="">BEST</a></li>
        ...
        <div class="fly-top-bar-back"></div>
    </div>
    <div class="main">
        <div class="swiper-container main-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="content"
                        style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/main1.png)"></div>
                </div>
                <div class="swiper-slide">
                    <div class="content"
                        style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/main2.png)"></div>
                </div>
                <div class="swiper-slide">
                    <div class="content"
                        style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/main3.png)"></div>
                </div>
                <div class="swiper-slide">
                    <div class="content"
                        style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/main4.png)"></div>
                </div>
                <div class="swiper-slide">
                    <div class="content"
                        style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/main5.png)"></div>
                </div>
                <div class="swiper-slide">
                    <div class="content"
                        style="background-image:url(https://sehee3527.github.io/img1/pf/chicor/main6.png)"></div>
                </div>
                <div class="swiper-slide">
                    <div class="content"
    ...
    <div class="bn-2 bn">
        <div class="new-arrivals con">
            <h2 class="new-arrivals-name title-name con">New Arrivals</h2>
            <div class="new-arrivals-slider-box">
